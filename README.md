...
> Be patient! In ~3 mins your app is live, at your [app url](https://container-gvk98eo.containers.anotherwebservice.com/). It even has a free SSL/TLS certificate 🔒 you're welcome!
...
Your app will be automatically re-deployed with the latest code at: https://container-gvk98eo.containers.anotherwebservice.com/
...
```
git clone git@github.com:chrisjsimpson/container-gvk98eo.git
cd container-gvk98eo
```
...
```
docker attach container-gvk98eo
```
